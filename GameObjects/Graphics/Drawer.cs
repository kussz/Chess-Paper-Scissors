...
namespace Graphics
{
    ...
    {
        public static void BoardDraw(this ShaderProgram shaderProg, int xSize, int ySize,Matrix4 mvpMatrix)
        {
            ...
            GL.DrawElements(PrimitiveType.Triangles, BoardVertices.GetBorderIndexes().Length, DrawElementsType.UnsignedInt, 0);
            
        }
        public static void TileDraw(this ShaderProgram shaderProg, Matrix4 mvpMatrix,int length)
        {
            int mvpMatrixLocation = shaderProg.UnifLocation("mvpMatrix");
            GL.BindVertexArray(shaderProg.VAO.Index);
            GL.UniformMatrix4(mvpMatrixLocation, false, ref mvpMatrix);
        ...
        public static void PieceDraw(this Piece drawable, Matrix4 mvpMatrix, ShaderProgram shaderProg)
        {
            int mvpMatrixLocation = shaderProg.UnifLocation("mvpMatrix");
            VAO VAO;
            GL.UniformMatrix4(mvpMatrixLocation, false, ref mvpMatrix);
